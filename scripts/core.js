        ...
        case this.INPUT_TEXT:
          // necessary according to https://stackoverflow.com/q/1520800
              this.input=this.input.replace(",","");
          	  		  	  percentinput=(parseFloat(this.input)/100);
	  percent=percentinput*parseFloat(this.output);
	  newoutput=parseFloat(this.input)-percent;
	  this.regExp.lastIndex = 0;
          return string.replace(this.regExp,newoutput.toFixed().toString());
